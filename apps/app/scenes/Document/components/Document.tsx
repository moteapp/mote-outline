...
class DocumentScene extends React.Component<Props> {
    ...
    render() {
        ...
        const favicon = hasEmojiInTitle
            ? emojiToUrl(document.icon!)
            : undefined;
                ...
                >
                    ...
                    <Container column>
                                    ...
                                    <>
                                        ...
                                        >
                                            ...
                                            <Editor
                                                ...
                                                onFileUploadStop={
                                                    this.onFileUploadStop
                                                }
                                                onSearchLink={
                                                    this.props.onSearchLink
                                                }
                                                onCreateLink={
                        ...
                        {isShare &&
                            ...
                            !auth.user && (
                                <Branding href="//www.mote.dev?ref=sharelink" />
                            )}
                    </Container>
                    {!isShare && (
                        <Footer>
