...
export class Environment {
    ...
    public DATABASE_URL_VECTOR = environment.DATABASE_URL_VECTOR;
    ...
    @IsEmail({ allow_display_name: true, allow_ip_domain: true })
    @IsOptional()
    public SMTP_REPLY_EMAIL = this.toOptionalString(
     ...
     */
    public SMTP_TLS_CIPHERS = this.toOptionalString(
    ...
    public RATE_LIMITER_COLLABORATION_REQUESTS =
        this.toOptionalNumber(
            environment.RATE_LIMITER_COLLABORATION_REQUESTS
        ) ?? 50;
    ...
    @Public
    @IsOptional()
    public AWS_S3_UPLOAD_BUCKET_URL =
        environment.AWS_S3_UPLOAD_BUCKET_URL ?? '';
    ...
    @IsIn(['local', 's3'])
    public FILE_STORAGE =
        this.toOptionalString(environment.FILE_STORAGE) ?? 's3';
    ...
    public FILE_STORAGE_WORKSPACE_IMPORT_MAX_SIZE =
        this.toOptionalNumber(
            environment.FILE_STORAGE_WORKSPACE_IMPORT_MAX_SIZE
        ) ??
        this.toOptionalNumber(environment.MAXIMUM_IMPORT_SIZE) ??
        this.toOptionalNumber(environment.FILE_STORAGE_UPLOAD_MAX_SIZE) ??
        1000000;
